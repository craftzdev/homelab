...
```
  ...
  -h, --help                                     help for dev
      ...
      --install-image string                     the installer image to use (default "ghcr.io/siderolabs/installer:v1.13.7")
      ...
      --talos-version string                     the desired Talos version to generate config for (default "v1.13.7")
...
```
      ...
      --state string   directory path to store cluster state (default "/Users/craftz/.talos/clusters")
```
...
```
  ...
  -h, --help                                     help for docker
      ...
      --image string                             the talos image to run (default "ghcr.io/siderolabs/talos:v1.13.7")
      --kubernetes-version string                desired kubernetes version to run (default "1.36.2")
...
```
  ...
  -h, --help                                     help for qemu
      ...
      --talos-version string                     the desired talos version (default "v1.13.7")
      --talosconfig-destination string           The location to save the generated Talos configuration file to. Defaults to 'TALOSCONFIG' env variable if set, otherwise '$HOME/.talos/config' and '/var/run/secrets/talos.dev/config' in order.
      --workers int                              the number of workers to create (default 1)
```
...
```
  ...
  -h, --help                                     help for config
      ...
      --install-image string                     the image used to perform an installation (default "ghcr.io/siderolabs/installer:v1.13.7")
      --kubernetes-version string                desired kubernetes version to run (default "1.36.2")
